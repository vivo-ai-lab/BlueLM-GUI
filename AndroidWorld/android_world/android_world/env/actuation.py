...
def find_and_click_element(
  ...
  """
  # Find text.
  action = _wait_and_find_click_element(
      element_text, env, case_sensitive, timeout
  )
...
def _wait_and_find_click_element(
  ...
  Args:
    ...
    case_sensitive: Whether to use case sensitivity when matching.
    timeout: Maximum time in seconds to wait for the element to appear.
    dist_threshold: Maximum allowed edit distance for a match.
  """
  ui_elements = env.get_ui_elements()
